        ...
        <div class="form-grid">
          <div class="form-card">
            ...
            <div class="form-group">
              ...
              <input type="text" formControlName="title" class="form-control" [class.error]="isFieldInvalid('title')">
              @if (isFieldInvalid('title')) { <span class="error-message">Title is required</span> }
            </div>
              <div class="form-row">
              <div class="form-group">
              ...
              <div class="form-group">
                ...
                <input type="number" formControlName="maxParticipants" class="form-control" [class.error]="isFieldInvalid('maxParticipants')">
                @if (isFieldInvalid('maxParticipants')) { <span class="error-message">Required, min 1</span> }
              </div>
            </div>
            <div class="form-group">
          ...
          <div class="form-card">
            ...
            <div class="form-row">
              ...
              <div class="form-group">
                <label>Time *</label>
                <input type="time" formControlName="time" class="form-control" [class.error]="isFieldInvalid('time')">
                @if (isFieldInvalid('time')) { <span class="error-message">Time is required</span> }
              </div>
            </div>
            <div class="form-group">
