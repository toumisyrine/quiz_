      ...
      @if (event) {
        ...
        <div class="details-grid">
          <div class="details-main">
            <div class="detail-card">
              ...
              <div class="card-body">
                ...
                <div class="detail-row"><span class="detail-label">Time</span><span class="detail-value">{{ event.time }}</span></div>
                <div class="detail-row"><span class="detail-label">Location</span><span class="detail-value">{{ event.location }}</span></div>
                <div class="detail-row"><span class="detail-label">Max Participants</span><span class="detail-value">{{ event.maxParticipants }}</span></div>
                @if (event.createdAt) {
                <div class="detail-row"><span class="detail-label">Created</span><span class="detail-value">{{ event.createdAt | date:'mediumDate' }}</span></div>
                }
              </div>
            </div>
            <div class="detail-card">
          ...
          <div class="details-sidebar">
            <div class="detail-card image-card"><img [src]="event.image" [alt]="event.title" class="event-image"></div>
          </div>
        </div>
      } @else {
